  ...
  >
    <template #actions>
      ...
      <el-button
        ...
        size="default"
        :icon="Tools"
        @click="handleViewRecords('maintain')"
      >
        查看维护记录
      </el-button>
      <el-button
    ...
    <template #row-actions="{ row, column }">
      <div class="action-buttons-container">
        <template
          v-for="(op, opIndex) in (column.prop ? row[column.prop] : [])"
          :key="opIndex"
        >
          <el-button
