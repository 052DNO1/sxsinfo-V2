...
export function useDashboardCharts(stats, chartStats, superuserChartStats, sxsadminChartStats, teacherChartStats, safeUser) {
  const canShowCharts = computed(() => {
    const u = safeUser.value
    return (u.is_super_admin && !u.is_superuser) || u.is_departadmin || u.is_sxsadmin || u.is_teacher
  })
