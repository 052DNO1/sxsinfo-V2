...
class GlobalSearchService:
    ...
    def search(self, requester, keyword: str, limit: int = 10) -> dict:
        ...
        results.extend(self._search_laboratories(requester, keyword, limit))
        results.extend(self._search_schedules(requester, keyword, limit))
        results.extend(self._search_records(requester, keyword, limit))
        results.extend(self._search_work_orders(requester, keyword, limit))
        results.extend(self._search_equipment(requester, keyword, limit))
        results.extend(self._search_users(requester, keyword, limit))
